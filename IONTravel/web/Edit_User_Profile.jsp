...
<html lang="en">
                ...
                <div class="main">
                    ...
                    <article id="content">
                        <div class="wrap">
                            <div class="box">
                                <div>
                                    <h2 class="letter_spacing">Edit <span>Profile</span></h2>
                                    <p class="letter_spacing">All field must be filled, and we'll make sure to keep secure your datas.</p>
                                    <form id="ContactForm">
                                        <div id="signupform">
                                            <table>
                                                <tr  id="input_signup">
                                                    <td><span>Password Lama:</span></td>
                                                    <td><input type="text" class="input" name="pwdOld"></td>								
                                                </tr><tr><td><span>Password Baru:</span></td>
    ...
    <input type="submit" class="button1" value="Ubah Profil" name="Ubah Profil">
</div>
</form>
</div>
</div>
