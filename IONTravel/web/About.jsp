...
<!-- content -->
			<article id="content">
				<div class="wrap">
					<div class="box">
						<div>
							<h2 class="letter_spacing">About <span>Us</span></h2>
							<img src="images/logo_big.png" alt="" id="descimage">
							<div id="desc">
								<p class="pad_bot1">ION Travel will take you anywhere you want in Indonesia! You just need to Plan it, give it to us and we'll realize it! All you have to do is Enjoy it!
								<br><br>
								This site is Group 8's Final Project for Web Service and Application course 2013.
								</p>
							</div>
						</div>
					</div>
