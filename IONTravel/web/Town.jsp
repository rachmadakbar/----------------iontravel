				...
				<header>
					...
					<nav>
						<ul id="menu">
							...
							<li class="active"><a href="Town.jsp">Kota</a></li>
		...
		<article id="content2">
			<section class="wrapper" id="bg">
				...
				<div class="page" id="pages" >
					...
					<div class="wrapper" id="page_town">
						<div id="p1" class="page _current">
							<div id="pack_box">
								<div id="pack">
									<img src="images/pack1.jpg" />
									<h3>Depok <span>Jawa Barat</span></h3>
									<a href = "#" onclick = "#" class="button1">Tempat Wisata</a>
									<a href = "#" onclick = "#" class="button1">Paket</a>
									<a href = "#" onclick = "#" class="btn_town_edit">Edit >></a> 
								</div>
							</div>
						</div>
