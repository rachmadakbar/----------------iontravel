...
<!-- content -->
			<article id="content">
				<div class="wrap">
					<div class="box">
						<div>
							<h2 name="name" class="letter_spacing">My Profile</h2>
							<table id="descontent">
								<tr>
									<td id="desclabel"><span>Username:</span></td>
								</tr><tr>
									<td id="desc">plain.yoghurt</td>								
								</tr><tr  id="description">
									<td  id="desclabel">Fullname:</td>							
								</tr>	
								<tr>
									<td  id="desc">Inas Sofiyah Junus</td>
								</tr><tr>
							...
							<a href="#" class="button1" onClick="" id="editdesc2">Edit Profile</a>
						</div>
					</div>
				</div>
			</article>
